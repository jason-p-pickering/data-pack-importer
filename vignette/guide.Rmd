...
This manual should guide through the Data Import process for COP18.
...
- Check for updates to the `prod` branch
...
- `*_import_*.csv` -> depending of issues (see below), continue to run Validation #2
...
In above step a CSV file was generated. This step checks if it is a valid DHIS2 import file. See this file for doing so:
https://github.com/jason-p-pickering/datim-validation/blob/master/vignettes/validating_data.Rmd
